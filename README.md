...
|----------------------|--------|-------------------------------------------------------------|
| demo_spacy           | 3.13.x | [View the demo_spacy README](./demo_spacy/README.md)        |
| demo_med7            | 3.11.x | [View the demo_spacy README](./demo_med7/README.md)         |
| demo_transformers    | 3.13.x | [View the demo_spacy README](./demo_transformers/README.md) |
| demo_label           | 3.12.x | [View the demo_spacy README](./demo_label/README.md)        |
